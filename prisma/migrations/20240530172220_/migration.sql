...
CREATE TABLE "Action" (
    ...
    "columnId" TEXT NOT NULL DEFAULT '0',
...
-- CreateIndex
CREATE INDEX "Column_pipelineId_idx" ON "Column"("pipelineId");
...
-- AddForeignKey
ALTER TABLE "Column" ADD CONSTRAINT "Column_pipelineId_fkey" FOREIGN KEY ("pipelineId") REFERENCES "Pipeline"("id") ON DELETE CASCADE ON UPDATE CASCADE;
